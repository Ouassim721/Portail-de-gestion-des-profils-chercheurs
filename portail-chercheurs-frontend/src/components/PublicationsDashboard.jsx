    ...
    <div className="p-6 space-y-6 bg-[var(--color-bg-secondary)] min-h-screen">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="bg-gradient-to-br from-purple-500 to-indigo-500 rounded-xl p-4 text-white shadow-lg">
          ...
          <p className="text-3xl font-bold my-2">{stats.total?.toLocaleString()}</p>
          <div className="flex items-center text-xs opacity-80">
            <span>↗ 12% sur l'année</span>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-br from-green-500 to-emerald-500 rounded-xl p-4 text-white shadow-lg">
          ...
          <div className="text-xs opacity-80">6 derniers mois</div>
        </div>
        ...
        <div className="bg-gradient-to-br from-pink-500 to-rose-500 rounded-xl p-4 text-white shadow-lg">
          ...
          <div className="text-xs opacity-80">vs {stats.currentMonthCount} ce mois</div>
        </div>
      </div>

      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-white rounded-xl p-4 shadow-lg">
          <h2 className="text-lg font-semibold mb-4">{t("publicationTrend")}</h2>
          <div className="h-80">
        ...
        <div className="bg-white rounded-xl p-4 shadow-lg">
          <h2 className="text-lg font-semibold mb-4">{t("monthlyComparison")}</h2>
          <div className="h-80">
            ...
            {comparisonData.labels.map((label, index) => (
              <div key={label} className="flex items-center">
                <span 
                  ...
                  style={{ backgroundColor: comparisonData.datasets[0].backgroundColor[index] }}
                ></span>

...
function Dashboard() {
  ...
  const processDisciplinesData = (chercheurs) => {
    ...
    chercheurs.forEach((chercheur) => {
      const discipline = chercheur.specialisation || t("unknownDiscipline");
      const count = chercheur.publications_count || 0;
      disciplineCounts[discipline] =
        (disciplineCounts[discipline] || 0) + count;
    });
          ...
          icon={
            ...
            >
              <path
                ...
                d="M7 8h10M7 12h6m5 8H6a2 2 0 01-2-2V6a2 2 0 012-2h7l5 5v11a2 2 0 01-2 2z"
              />
            </svg>
          }
        />
  ...
  <div className="p-8 max-w-2xl mx-auto">
    <div className="bg-red-50 border-l-4 border-red-400 p-4">
      <div className="flex items-center">
        <svg
          className="h-5 w-5 text-red-400 mr-4"
          viewBox="0 0 20 20"
          fill="currentColor"
        >
          <path
